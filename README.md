...
| `page-cleaner.user.js`       | 页面清理    | 删除页面中的无用元素、使标签栏可滑动。                          | 通用                   | 还包括提交后自动恢复答题区、上下键滚动页面等功能。                                           |
...
| `handwriting-fix.user.js`    | 手写修复    | 修复手写作答和草稿窗口上下滑动问题，在有手写笔时用触摸滚动，手写作答支持同时显示题干同。 | 通用                   | 草稿的橡皮擦和清屏有兼容性问题，且无法删除草稿，这是新能源的问题；仅Edge安卓版有窗口滑动问题。                   |
